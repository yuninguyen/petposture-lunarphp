        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('body_type')
                    ->label(__('Body Type'))
                    ->options([
                        'flat-faced' => __('Flat-Faced (Brachycephalic)'),
                        'long-backed' => __('Long-Backed / Low-Bodied'),
                    ])
                    ->placeholder(__('None')),
                ...
                Forms\Components\Section::make(__('SEO Settings'))
                    ->description(__('Optimize this breed page for search engines and social media.'))
                    ->schema([
