...
class OrderResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'attribution_origin' => $meta['attribution_origin'] ?? null,
            'attribution_device_type' => $meta['attribution_device_type'] ?? null,
            'attribution_session_page_views' => $meta['attribution_session_page_views'] ?? null,
            ...
            'customer_user_agent' => $meta['customer_user_agent'] ?? null,
            'customer_ip_service_type' => $meta['customer_ip_service_type'] ?? null,
