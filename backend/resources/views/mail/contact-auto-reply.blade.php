...
<tr>
<td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; background-color:#fdf1e7; border-radius:100px; padding:6px 16px; font-size:11px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#df8448;">&#10003; Message Received</td>
</tr>
</table>
<h1 style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; margin:0; font-size:26px; line-height:1.3; font-weight:700; color:#3e4c57;">We got your message, {{ $senderName }}!</h1>
</td>
</tr>
...
Thanks for reaching out to {{ config('app.name') }}. We've received your message about <strong style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; color:#3e4c57;">&ldquo;{{ $originalSubject }}&rdquo;</strong> and our support team will get back to you within <strong style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; color:#3e4c57;">24 business hours</strong>.
</p>
</td>
</tr>
...
<td style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; padding-bottom:16px;">A member of our support team will personally review your message</td>
</tr></table>
</td>
</tr>
<tr>
...
<table role="presentation" cellpadding="0" cellspacing="0"><tr>
<td valign="top" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; width:22px; padding-top:1px;"><span style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; display:inline-block; width:16px; height:16px; border-radius:50%; background-color:#df8448; color:#ffffff; font-size:10px; font-weight:700; text-align:center; line-height:16px;">&#10003;</span></td>
<td>You'll hear back at the email address you wrote in from</td>
</tr></table>
</td>
</tr>
</table>
...
<a href="{{ config('app.frontend_url') }}/faqs" target="_blank" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; display:inline-block; padding:16px 44px; font-size:12px; font-weight:700; letter-spacing:2px; text-transform:uppercase; color:#ffffff; text-decoration:none;">Browse FAQs</a>
</td>
</tr>
</table>
</td>
...
Need to add anything? Just reply to this email — it goes straight to our support team.<br>
