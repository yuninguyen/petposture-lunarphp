...
<tr>
<td align="center" style="{{ $font }} padding:40px 16px;">
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="{{ $font }} max-width:600px; width:100%;">
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="{{ $font }} border:1px solid #ececec; border-radius:10px;">
<tr>
<td style="{{ $font }} padding:32px;">

<p style="{{ $font }} margin:0 0 20px; font-size:15px; line-height:1.6; color:#1a1a1a;">Hi {{ $order->shippingAddress?->first_name ?? 'there' }},</p>

<p style="{{ $font }} margin:0 0 20px; font-size:15px; line-height:1.6; color:#1a1a1a;">Your credit has been processed for order #{{ $order->reference }}.</p>

<p style="{{ $font }} margin:0 0 20px; font-size:15px; line-height:1.6; color:#1a1a1a;">
...
<p style="{{ $font }} margin:0 0 20px; font-size:15px; line-height:1.6; color:#1a1a1a;">
If you have further questions on your {{ config('app.name') }}.com order, please visit our <a href="{{ rtrim(config('app.frontend_url'), '/') }}/faqs" style="{{ $font }} color:#df8448; text-decoration:none; font-weight:600;">Help Section</a> for more information.
</p>

<p style="{{ $font }} margin:0; font-size:15px; line-height:1.6; color:#1a1a1a;">Thanks for shopping at {{ config('app.name') }}!</p>
...
<tr>
<td style="{{ $font }} border-top:1px solid #ececec; padding-top:24px; padding-bottom:12px;">
<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
<tr>
