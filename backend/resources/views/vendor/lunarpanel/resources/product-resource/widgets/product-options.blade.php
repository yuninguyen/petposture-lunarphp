                      ...
                      <div class="flex items-center gap-1">
                        @if($permutation['variant_id'])
                          <x-filament::icon-button
                            ...
                            :label="__('lunarpanel::productoption.widgets.product-options.variants-table.actions.edit.label')"
                            :tooltip="__('lunarpanel::productoption.widgets.product-options.variants-table.actions.edit.label')"
                          />
                        @endif
                        <x-filament::icon-button
                          icon="heroicon-o-trash"
                          color="danger"
                          wire:click="removeVariant('{{ $permutationIndex }}')"
                          :label="__('lunarpanel::productoption.widgets.product-options.variants-table.actions.delete.label')"
                          :tooltip="__('lunarpanel::productoption.widgets.product-options.variants-table.actions.delete.label')"
                        />
                      </div>
                    </x-filament-tables::cell>
