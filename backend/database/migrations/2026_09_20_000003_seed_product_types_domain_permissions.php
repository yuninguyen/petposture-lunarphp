...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds product type abilities idempotently for production and development.
     * Ensures Product Manager and core roles receive product type permissions even
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::PRODUCT_TYPES as $name) {
        ...
        // Grant product type abilities to Product Manager
        ...
        if ($productManager) {
            $productManager->givePermissionTo(AdminAbilityRegistry::PRODUCT_TYPES);
        }
