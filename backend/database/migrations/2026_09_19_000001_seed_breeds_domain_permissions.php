...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds breed abilities idempotently for production and development.
     * Ensures Product Manager and core roles receive breed permissions even
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::BREEDS as $name) {
        ...
        // Grant breed abilities to Product Manager
        ...
        if ($productManager) {
            $productManager->givePermissionTo(AdminAbilityRegistry::BREEDS);
        }
