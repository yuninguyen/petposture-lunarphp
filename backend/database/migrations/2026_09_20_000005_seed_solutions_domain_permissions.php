...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds solution abilities idempotently for production and development.
     * Ensures Product Manager and core roles receive solution permissions even
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::SOLUTIONS as $name) {
        ...
        // Grant solution abilities to Product Manager
        ...
        if ($productManager) {
            $productManager->givePermissionTo(AdminAbilityRegistry::SOLUTIONS);
        }
