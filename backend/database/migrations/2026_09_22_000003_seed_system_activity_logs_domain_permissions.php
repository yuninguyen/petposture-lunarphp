...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds system activity logs abilities idempotently for production and development.
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::SYSTEM_ACTIVITY_LOGS as $name) {
        ...
        foreach (AdminAbilityRegistry::coreRoles() as $coreRole) {
            ...
            if ($role) {
                $role->givePermissionTo(AdminAbilityRegistry::SYSTEM_ACTIVITY_LOGS);
            }
        }
