...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds collection abilities idempotently for production and development.
     * Ensures Product Manager and core roles receive collection permissions even
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::COLLECTIONS as $name) {
        ...
        // Grant collection abilities to Product Manager
        ...
        if ($productManager) {
            $productManager->givePermissionTo(AdminAbilityRegistry::COLLECTIONS);
        }
