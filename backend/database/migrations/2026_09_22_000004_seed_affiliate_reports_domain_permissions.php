...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds affiliate reports abilities idempotently for production and development.
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::AFFILIATE_REPORTS as $name) {
        ...
        foreach (AdminAbilityRegistry::coreRoles() as $coreRole) {
            ...
            if ($role) {
                $role->givePermissionTo(AdminAbilityRegistry::AFFILIATE_REPORTS);
            }
        }
