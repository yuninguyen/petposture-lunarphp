...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds system media abilities idempotently for production and development.
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::SYSTEM_MEDIA as $name) {
        ...
        foreach (AdminAbilityRegistry::coreRoles() as $coreRole) {
            ...
            if ($role) {
                $role->givePermissionTo(AdminAbilityRegistry::SYSTEM_MEDIA);
            }
        }
