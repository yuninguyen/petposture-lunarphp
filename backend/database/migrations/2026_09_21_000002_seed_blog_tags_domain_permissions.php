...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds blog tag abilities idempotently for production and development.
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::BLOG_TAGS as $name) {
        ...
        foreach (AdminAbilityRegistry::coreRoles() as $coreRole) {
            ...
            if ($role) {
                $role->givePermissionTo(AdminAbilityRegistry::BLOG_TAGS);
            }
        }
