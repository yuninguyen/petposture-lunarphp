...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds comment abilities idempotently for production and development.
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::COMMENTS as $name) {
        ...
        foreach (AdminAbilityRegistry::coreRoles() as $coreRole) {
            ...
            if ($role) {
                $role->givePermissionTo(AdminAbilityRegistry::COMMENTS);
            }
        }
