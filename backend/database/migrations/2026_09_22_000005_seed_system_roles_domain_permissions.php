...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds system roles abilities idempotently for production and development.
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::SYSTEM_ROLES as $name) {
        ...
        foreach (AdminAbilityRegistry::coreRoles() as $coreRole) {
            ...
            if ($role) {
                $role->givePermissionTo(AdminAbilityRegistry::SYSTEM_ROLES);
            }
        }
