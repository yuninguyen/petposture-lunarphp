...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Seeds affiliate networks abilities idempotently for production and development.
    ...
    public function up(): void
    {
        ...
        foreach (AdminAbilityRegistry::AFFILIATE_NETWORKS as $name) {
        ...
        foreach (AdminAbilityRegistry::coreRoles() as $coreRole) {
            ...
            if ($role) {
                $role->givePermissionTo(AdminAbilityRegistry::AFFILIATE_NETWORKS);
            }
        }
