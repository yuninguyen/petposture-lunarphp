...
use App\Http\Controllers\Api\Admin\AiSeoController;
...
Route::post('/orders/resend-tracking-link', [OrderController::class, 'resendTrackingLink'])->middleware('throttle:order-public');
...
Route::prefix('/admin')
    ...
    ->group(function () {
        ...
        Route::get('/affiliate/networks', [AffiliateNetworkManagementController::class, 'index']);
        Route::post('/affiliate/networks', [AffiliateNetworkManagementController::class, 'store']);
        Route::get('/affiliate/networks/{network}', [AffiliateNetworkManagementController::class, 'show']);
        Route::put('/affiliate/networks/{network}', [AffiliateNetworkManagementController::class, 'update']);
        Route::delete('/affiliate/networks/{network}', [AffiliateNetworkManagementController::class, 'destroy']);
        Route::post('/affiliate/networks/{network}/sync', [AffiliateNetworkManagementController::class, 'sync']);
        ...
        Route::post('/blog/categories/bulk-delete', [BlogCategoryController::class, 'bulkDestroy']);
        ...
        Route::post('/blog/tags/bulk-delete', [BlogTagController::class, 'bulkDestroy']);
        Route::get('/blog/tags', [BlogTagController::class, 'index']);
        Route::post('/blog/tags', [BlogTagController::class, 'store']);
        Route::get('/blog/tags/{blogTag}', [BlogTagController::class, 'show']);
        Route::put('/blog/tags/{blogTag}', [BlogTagController::class, 'update']);
        Route::patch('/blog/tags/{blogTag}', [BlogTagController::class, 'update']);
        ...
        Route::get('/orders/shipping-methods', [ShippingMethodController::class, 'picker']);
        ...
        Route::post('/media', [MediaController::class, 'store'])->middleware('throttle:api-write');
        Route::patch('/media/{media}', [MediaController::class, 'update'])->middleware('throttle:api-write');
        Route::get('/affiliate-networks', [AffiliateNetworkController::class, 'index']);

        Route::get('/seo-social', [SeoSocialController::class, 'index']);
        Route::post('/seo-social', [SeoSocialController::class, 'store']);

        Route::post('/pages/bulk-delete', [PageController::class, 'bulkDestroy']);
