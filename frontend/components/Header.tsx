    ...
    <header className="w-full relative z-50 flex flex-col font-sans">
        ...
        <div className="max-w-[1200px] mx-auto w-full px-6 flex items-center justify-between h-full gap-4 md:gap-8">
          ...
          <div className="hidden md:flex flex-1 max-w-[500px]">
            <div className="flex w-full border border-zinc-300 rounded overflow-hidden focus-within:border-zinc-400 transition-colors">
              ...
              />
              <button
                className="bg-[#a8542a] text-white px-8 h-[44px] font-bold tracking-wider text-[11px] uppercase hover:bg-[#8f4620] transition-colors border-none m-0 rounded-none"
              >
                Search
              </button>
            </div>
          ...
          <div className="flex items-center gap-4 md:gap-6 text-primary flex-shrink-0">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                <Link href="/account" className="text-[12px] font-bold uppercase tracking-widest text-[#a8542a] hidden lg:block hover:underline">
            ...
            >
              ...
              {items.length > 0 && (
                <span className="absolute -top-1 -right-1.5 bg-[#a8542a] text-white text-[9px] font-black rounded-full w-4 h-4 flex items-center justify-center shadow-sm">
      ...
      <div className="md:hidden bg-white p-4 border-b border-zinc-100">
        <div className="flex w-full border-2 border-zinc-200 rounded overflow-hidden">
          ...
          />
          <button className="bg-[#a8542a] px-4 text-white uppercase text-[10px] font-bold">
            Search
          </button>
        </div>
      </div>
                ...
                <nav className="space-y-1">
                  {[
                    ...
                    <Link
                      ...
                      href={item.href}
                      onClick={() => setMobileOpen(false)}
                      className={`flex items-center justify-between px-4 py-4 rounded-xl group transition-all duration-300 mb-1 ${isActive(item.href) ? "bg-[#a8542a]" : "text-primary hover:bg-zinc-50"
                        }`}
                    >
