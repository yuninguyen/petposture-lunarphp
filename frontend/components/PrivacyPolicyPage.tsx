                    ...
                    <div className="flex-1 max-w-[800px]">
                        <div className="prose prose-zinc max-w-none text-[#4a4a4a] text-[16px] leading-[1.8]">
                            ...
                            <ul className="list-disc pl-6 mb-8 space-y-2">
                                <li>Visit our website at <a href="http://petposture.com" className="text-secondary hover:underline">http://petposture.com</a>, or any website of ours that links to this privacy notice</li>
                                <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                            </ul>
                            <p className="mb-12">
                                <strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:support@petposture.com" className="text-secondary hover:underline">support@petposture.com</a>.
                            </p>

                            {/* Summary of Key Points */}
                            <div className="bg-[#f8fafc] border border-zinc-100 rounded-2xl p-8 mb-16 shadow-sm">
                                <h2 className="text-[24px] font-bold text-primary mb-6 uppercase tracking-tight">SUMMARY OF KEY POINTS</h2>
                            ...
                            <div className="space-y-20">
                                <section id="info-collect">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">1. WHAT INFORMATION DO WE COLLECT?</h2>
                                    ...
                                    <h3 className="text-[20px] font-bold text-primary mt-8 mb-4">Personal Information Provided by You</h3>
                                ...
                                <section id="info-process">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
                                ...
                                <section id="share-info">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
                                ...
                                <section id="cookies">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
                                ...
                                <section id="social-logins">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
                                ...
                                <section id="international">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">6. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h2>
                                ...
                                <section id="retention">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                                ...
                                <section id="minors">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">8. DO WE COLLECT INFORMATION FROM MINORS?</h2>
                                ...
                                <section id="rights">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                                ...
                                <section id="dnt">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
                                ...
                                <section id="updates">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                                ...
                                <section id="contact">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                                    <p>If you have questions or comments about this notice, you may email us at <a href="mailto:support@petposture.com" className="text-secondary hover:underline">support@petposture.com</a> or by post to:</p>
                                ...
                                <section id="review">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
                                    <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: <a href="mailto:support@petposture.com" className="text-secondary hover:underline">support@petposture.com</a>.</p>
                                </section>

                                <section id="us-state-rights">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">14. YOUR U.S. STATE PRIVACY RIGHTS</h2>
                                    ...
                                    <p>To exercise any of these rights, please contact us at <a href="mailto:support@petposture.com" className="text-secondary hover:underline">support@petposture.com</a>. We will verify your request and respond within the timeframe required by applicable law.</p>
                                </section>
                            </div>
                        </div>
                    </div>
