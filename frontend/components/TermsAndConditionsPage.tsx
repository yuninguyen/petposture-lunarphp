                    ...
                    <div className="flex-1 max-w-[800px]">
                        <div className="prose prose-zinc max-w-none text-[#4a4a4a] text-[16px] leading-[1.8]">
                            ...
                            <div className="space-y-20">
                                <section id="services">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">1. OUR SERVICES</h2>
                                ...
                                <section id="ip">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">2. INTELLECTUAL PROPERTY RIGHTS</h2>
                                ...
                                <section id="representations">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">3. USER REPRESENTATIONS</h2>
                                ...
                                <section id="prohibited">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">4. PROHIBITED ACTIVITIES</h2>
                                    <p>You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>
                                </section>

                                <section id="contributions">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">5. USER-GENERATED CONTRIBUTIONS</h2>
                                ...
                                <section id="license">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">6. CONTRIBUTION LICENSE</h2>
                                ...
                                <section id="management">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">7. SERVICES MANAGEMENT</h2>
                                ...
                                <section id="termination">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">8. TERM AND TERMINATION</h2>
                                ...
                                <section id="modifications">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">9. MODIFICATIONS AND INTERRUPTIONS</h2>
                                ...
                                <section id="governing-law">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">10. GOVERNING LAW</h2>
                                ...
                                <section id="dispute">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">11. DISPUTE RESOLUTION</h2>
                                    <h3 className="text-[20px] font-bold text-primary mt-8 mb-4">Binding Arbitration</h3>
                                ...
                                <section id="corrections">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">12. CORRECTIONS</h2>
                                ...
                                <section id="disclaimer">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">13. DISCLAIMER</h2>
                                ...
                                <section id="liability">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">14. LIMITATIONS OF LIABILITY</h2>
                                ...
                                <section id="indemnification">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">15. INDEMNIFICATION</h2>
                                ...
                                <section id="user-data">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">16. USER DATA</h2>
                                ...
                                <section id="electronics">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                                ...
                                <section id="misc">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">18. MISCELLANEOUS</h2>
                                ...
                                <section id="affiliate">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">19. AFFILIATE DISCLOSURE</h2>
                                    ...
                                    <p>Certain content on the Site, including product comparisons and buying guides, contains affiliate links to third-party retailers. If you make a purchase through one of these links, we may receive a commission. This does not affect the price you pay. See our <a href="/affiliate-disclosure" className="text-secondary hover:underline">Affiliate Disclosure</a> for full details.</p>
                                </section>

                                <section id="contact">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">20. CONTACT US</h2>
                                    ...
                                    <p>United States</p>
                                    <p className="mt-4">
                                        Email: <a href="mailto:support@petposture.com" className="text-secondary hover:underline">support@petposture.com</a>
                                    </p>
                                </section>
                            </div>
                        </div>
