            ...
            <section className="py-6 md:py-10 px-4 bg-primary text-white text-center relative overflow-hidden group">
                ...
                <div className="max-w-[1200px] mx-auto relative z-10">
                    ...
                    >
                        ...
                        <Link
                            href="/shop"
                            className="inline-block px-10 py-3 border-2 border-secondary text-secondary font-bold uppercase tracking-[.2em] text-[15px] hover:bg-secondary hover:text-ink transition-all duration-500 rounded relative group overflow-hidden"
                        >
