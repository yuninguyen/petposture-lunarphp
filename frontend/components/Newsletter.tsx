            ...
            <form className="flex flex-col gap-3 group" noValidate>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  spellCheck={false}
                  className="w-full border-b-2 border-zinc-100 py-4 px-1 text-sm font-bold uppercase tracking-widest focus:outline-none focus:border-secondary transition-all bg-transparent placeholder:text-zinc-200"
                />
              </div>
              <button
                type="submit"
                className="bg-secondary hover:bg-primary text-white px-8 py-4 font-black text-sm uppercase tracking-[0.25em] transition-all shadow-xl hover:-translate-y-1 active:scale-95 whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
