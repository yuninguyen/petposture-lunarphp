                        ...
                        <div className="prose prose-zinc max-w-none text-[#4a4a4a] text-[16px] leading-[1.8]">
                            ...
                            <div className="space-y-20">
                                <section id="disclosure">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">1. AFFILIATE DISCLOSURE</h2>
                                ...
                                <section id="how-it-works">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">2. HOW AFFILIATE LINKS WORK</h2>
                                ...
                                <section id="our-commitment">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">3. OUR EDITORIAL COMMITMENT</h2>
                                ...
                                <section id="ftc">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">4. FTC COMPLIANCE</h2>
                                ...
                                <section id="contact">
                                    <h2 className="text-[28px] font-bold text-primary uppercase tracking-tight mb-6">5. HOW CAN YOU CONTACT US ABOUT THIS DISCLOSURE?</h2>
                                    <p>If you have questions about our affiliate relationships, you may email us at <a href="mailto:support@petposture.com" className="text-secondary hover:underline">support@petposture.com</a> or by post to:</p>
