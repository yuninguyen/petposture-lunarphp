            ...
            <section className="py-20 px-4 md:px-8 bg-white relative overflow-hidden">
                ...
                <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-7 bg-white p-8 md:p-12 rounded-2xl border border-zinc-100 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)]">
                        ...
                        {status === 'success' && (
                            <div className="flex items-start gap-3 p-5 mb-8 bg-green-50 border border-green-200 rounded-xl text-green-800 text-sm font-medium leading-relaxed">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                            ...
                            {/* Sending notice */}
                            {status === 'loading' && (
                                <p className="text-sm text-zinc-400 font-medium">{MESSAGES.sending}</p>
                            )}
                            ...
                            <button
                                ...
                                className="w-full md:w-auto bg-secondary hover:bg-secondary-dark text-ink px-12 py-5 font-bold text-sm uppercase tracking-[0.08em] transition-colors rounded-[3px] shadow-md flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed group"
                            >
                                {status === 'loading' ? (
