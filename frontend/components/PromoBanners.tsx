          ...
          {banners.map(({ image, title, href }, i) => (
            <div key={i} className="relative group overflow-hidden" style={{ height: "380px" }}>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-white text-center">
                ...
                <Link
                  href={href}
                  className="inline-block bg-secondary hover:bg-white hover:text-primary text-ink text-sm font-black uppercase tracking-[0.25em] px-8 py-3.5 transition-all shadow-md active:scale-95"
                >
                  Shop Now
                </Link>
              </div>
