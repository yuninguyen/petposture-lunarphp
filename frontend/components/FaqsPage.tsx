                ...
                <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="flex-1 max-w-[800px]">
                        ...
                        <div className="mt-16 bg-[#f8f9fa] rounded-2xl p-10 text-center border border-zinc-100">
                            ...
                            <a
                                href="/contact"
                                className="inline-block bg-secondary text-ink px-10 py-4 rounded-[3px] border-2 border-secondary font-bold uppercase tracking-[0.08em] text-sm hover:bg-secondary-dark hover:border-secondary-dark transition-all"
                            >
                                Contact Support
                            </a>
                        </div>
