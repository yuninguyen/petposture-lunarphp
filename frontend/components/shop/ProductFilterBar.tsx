        ...
        <aside className="lg:sticky lg:top-8">
            <div className="overflow-hidden rounded-[28px] border border-[#eadfd3] bg-white shadow-[0_18px_50px_rgba(34,33,33,0.05)]">
                <div className="border-b border-[#f0e7de] px-6 py-5">
                    <p className="text-xs font-bold uppercase tracking-[0.05em] text-[#9a806a]">Refine Catalog</p>
                ...
                <div className="space-y-7 px-6 py-6">
                    ...
                    {hasActiveFilters && (
                        <button
                            ...
                            className="h-[48px] w-full rounded-[16px] border border-[#d9c6b5] text-sm font-bold uppercase tracking-[0.05em] text-[#7d5f49] transition hover:border-secondary hover:text-rust"
                        >
                            Reset Filters
                        </button>
                    )}
