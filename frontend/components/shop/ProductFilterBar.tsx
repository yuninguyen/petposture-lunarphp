                ...
                <div className="space-y-7 px-6 py-6">
                    ...
                    {hasActiveFilters && (
                        <button
                            ...
                            className="h-[48px] w-full rounded-[16px] border border-[#d9c6b5] text-sm font-bold uppercase tracking-[0.14em] text-[#7d5f49] transition hover:border-secondary hover:text-rust"
                        >
                            Reset Filters
                        </button>
                    )}
