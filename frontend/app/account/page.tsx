...
import { Package, MapPin, User as UserIcon, LogOut, Trash2, Plus, X } from 'lucide-react';
                            ...
                            {loading ? (
                                ...
                                orders.length === 0 ? (
                                    ...
                                    <div className="space-y-4">
                                        {orders.map((order) => (
                                            <div key={order.id} className="flex items-center justify-between border border-zinc-100 rounded-xl p-4">
                                                <div>
                                ...
                                <div className="space-y-4 text-[14px] text-[#3e4c57]">
                                    <div>
