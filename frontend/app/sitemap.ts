...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    const staticPages: MetadataRoute.Sitemap = [
        ...
        { url: `${SITE_URL}/shop/solutions/mobility-support`, changeFrequency: 'weekly', priority: 0.7 },
        { url: `${SITE_URL}/shop/solutions/comfort-safety`, changeFrequency: 'weekly', priority: 0.7 },
