        ...
        return (
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl shadow-slate-200/50 border border-zinc-100 max-w-md w-full text-center space-y-6">
                ...
                <button
                    ...
                    className="bg-secondary text-ink px-8 py-4 rounded-[3px] font-bold uppercase tracking-widest text-sm hover:bg-secondary-dark transition-colors"
                >
                    Sign In
                </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="pt-4">
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-secondary text-ink py-5 rounded-[3px] font-bold uppercase tracking-[0.25em] text-sm hover:bg-secondary-dark disabled:opacity-50 transition-all shadow-xl shadow-orange-100 flex items-center justify-center gap-3 group"
                    >
