...
/** Role-identity helper kept for display purposes (badges, labels) only — never for authorization. */
...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    canAccess: (abilities) => (
      ...
      || can(abilities, 'view_any_shipping_method')
      || can(abilities, 'view_any_discount')
    ),
    items: [
      {
        key: 'orders',
  ...
  },
  {
    ...
    canAccess: (abilities) => (
      ...
      || can(abilities, 'view_any_blog_tag')
      || can(abilities, 'view_seo_social')
      || can(abilities, 'view_any_page')
    ),
    items: [
      {
        key: 'blog-categories',
  ...
  },
  {
    ...
    canAccess: (abilities) => (
      ...
      || can(abilities, 'view_any_activity_log')
      || can(abilities, 'view_general_settings')
    ),
    items: [
      {
        key: 'users',
      ...
      {
        key: 'activity-logs',
        labelKey: 'system_activity_logs.title',
