...
export interface Order {
  id: string; reference: string; status: string; status_label?: string | null; payment_status: string; payment_status_label?: string | null; fulfillment_status: string; fulfillment_status_label?: string | null; customer_email: string | null; coupon_code?: string | null; refund_status?: string | null; refund_amount?: number | null; refunded_at?: string | null; returned_at?: string | null; sub_total?: number; discount_total?: number; shipping_total?: number; shipping_label?: string | null; tax_total?: number; attribution_origin?: string | null; attribution_device_type?: string | null; attribution_session_page_views?: number | null; fraud_risk_level?: string | null; fraud_risk_score?: number | null; fraud_seller_message?: string | null; customer_ip?: string | null; customer_ip_location?: string | null; customer_ip_isp?: string | null; customer_user_agent?: string | null; customer_ip_service_type?: string | null; payment_method?: string | null; payment_label?: string | null; payment_gateway?: string | null; card_funding?: 'credit' | 'debit' | 'prepaid' | 'unknown' | string | null; card_brand?: string | null; card_last4?: string | null; paypal_payer_email?: string | null; customer_note?: string | null; total: OrderMoney; created_at: string | null; lines?: OrderLine[]; shipping_address?: OrderAddress; billing_address?: OrderAddress; order_events?: OrderEvent[];
