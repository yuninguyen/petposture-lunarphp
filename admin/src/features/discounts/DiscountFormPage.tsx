  ...
  return <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <Section title={t('discounts.core')}>
        <Field label={t('discounts.name')}><input id="discount-name" required value={values.name} onChange={(event) => update('name', event.target.value)} className="input" /></Field>
        <Field label={t('discounts.handle')}><input id="discount-handle" required value={values.handle} onChange={(event) => { setHandleEdited(true); update('handle', event.target.value); }} className="input" /></Field>
        <Field label={t('discounts.starts')}><input id="discount-starts-at" required type="datetime-local" value={values.starts_at} onChange={(event) => update('starts_at', event.target.value)} className="input" /></Field>
        <Field label={t('discounts.ends')}><input id="discount-ends-at" type="datetime-local" value={values.ends_at} onChange={(event) => update('ends_at', event.target.value)} className="input" /></Field>
        <Field label={t('discounts.priority')}><input id="discount-priority" type="number" value={values.priority} onChange={(event) => update('priority', event.target.value)} className="input" /></Field>
      ...
      <Section title={t('discounts.conditions')}>
        <Field label={t('discounts.coupon')}><input id="discount-coupon" required value={values.coupon} onChange={(event) => update('coupon', event.target.value)} className="input" /></Field>
        <Field label={t('discounts.max_uses')}><input id="discount-max-uses" min="1" type="number" value={values.max_uses} onChange={(event) => update('max_uses', event.target.value)} className="input" /></Field>
        <Field label={t('discounts.max_uses_per_user')}><input id="discount-max-uses-per-user" min="1" type="number" value={values.max_uses_per_user} onChange={(event) => update('max_uses_per_user', event.target.value)} className="input" /></Field>
        <Field label={t('discounts.min_price_usd')}><input id="discount-min-price-usd" min="0" step="0.01" type="number" value={values.min_price_usd} onChange={(event) => update('min_price_usd', event.target.value)} className="input" /></Field>
      </Section>
      <Section title={t('discounts.type_configuration')}>
        ...
        {values.fixed_value ? <Field label={t('discounts.fixed_value_usd')}><input id="discount-fixed-value-usd" min="0" step="0.01" type="number" value={values.fixed_value_usd} onChange={(event) => update('fixed_value_usd', event.target.value)} className="input" /></Field> : <Field label={t('discounts.percentage')}><input id="discount-percentage" min="0" max="100" step="0.01" type="number" value={values.percentage} onChange={(event) => update('percentage', event.target.value)} className="input" /></Field>}
      </Section>
