          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 flex items-center justify-end">
              <button
                ...
                className="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50"
              >
